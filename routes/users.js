...
// Login Page
router.get('/login', forwardAuthenticated, (req, res) => res.send({Response: "Please Login with credentials"}));

// Register Page
router.get('/register', forwardAuthenticated, (req, res) => res.send({Response: "Please register with credentials"}));
