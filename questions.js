const questions = [
  ...
  //   hint: `The first number, that is not reachable with 8 bit, what day is it in some far away country.`,
  //   puzzle: ``,
  //   puzzleAns: ``,
  // },
  // {
  ...
  //   category: `0`,
  //   score: 250,
  //   answer: `reverse the matrix, take a transpose`,
  ...
  //   hint: `Key Another name for dragon.`,
  ...
  //   score: 600,
  //   answer: `MEGD`,
  //   hint: `Small enough to be brute forced.`,
  ...
  //   score: 800,
  //   answer: `SUPERUSERR`,
  //   hint: `What is the year that anyone can easily remember, that’s right, current year.`,
